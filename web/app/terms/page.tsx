      ...
      <div className="mx-auto min-h-screen max-w-[1500px] overflow-hidden bg-[#f7f3ea] lg:grid lg:grid-cols-[0.34fr_0.66fr]">
        <aside className="relative overflow-hidden bg-[#111827] px-6 py-8 text-white sm:px-10 lg:min-h-screen lg:px-12">
          ...
          <div className="relative z-10 flex h-full flex-col">
            <div className="flex items-center justify-between"><Link href="/" className="inline-flex items-center gap-3 text-sm font-black"><span className="grid h-11 w-11 rotate-[-6deg] place-items-center rounded-xl bg-[#f6f0e4] text-xs font-black text-[#111827]">H!</span>Hi!Book</Link><span className="font-mono text-[10px] text-white/35">LEGAL / 01</span></div>
