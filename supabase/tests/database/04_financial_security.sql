...
select is((update public.coin_wallets set available_balance=999999 where id='42000000-0000-0000-0000-000000000011')::text,'','authenticated users cannot modify wallet balances');
