...
select is(has_function_privilege('public','public.get_moderation_queue(public.moderation_case_status,public.moderation_priority,integer)','EXECUTE'), false, 'moderation queue is not executable by PUBLIC');
select is(has_function_privilege('anon','public.get_moderation_queue(public.moderation_case_status,public.moderation_priority,integer)','EXECUTE'), false, 'moderation queue is not executable by anon');
