...
-- Finalize the moderation permission boundary:
-- case assignment and moderation-action execution are separate capabilities.
...
begin
  ...
  insert into public.moderation_actions (
    ...
    target_reason, target_severity, auth.uid(), target_starts_at, target_expires_at,
